//general form field, used for page generation and form validation
class FormField{
    ...
    //returns the cleaned value and if the value was valid
    validate(value){
        var valid = false;
        var cleanValue = [];
...
// different type of field, with same data, but different verification method
